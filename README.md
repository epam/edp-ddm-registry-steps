...
* @Тоді("дата модель повертає json, що містить точно наступні дані, ігноруючі невказані:")
    * Нижче цього кроку необхідно у вигляді строки вказати очікувані дані отримані у відповідь на запит  
      Приклад:
...
```gherkin 
     Тоді дата модель повертає точно заданий json з файлу "features/data/search-conditions/type/type_read_all.json", ігноруючі невказані
``` 
